...
oot_channel_id_list = [
    "645671746195816471",#add the channels you want to fetch answers from
]
...
class Bot(discord.Client):
    ...
    def __init__(self, answer_scores):
        ...
        # embed creation
        self.embed=discord.Embed(title="Loco AnsWer Bot")
        ...
        self.embed.set_footer(text='Ⱨ₳₵₭ɆⱤ ₱Ɽł₮₳₥▄︻̷̿┻̿═━#6898')
    ...
    async def on_ready(self):
        ...
        await self.change_presence(activity=discord.Game(name='with LoCo TriVia | lo'))
...
def bot_with_cyclic_update_process(update_event, answer_scores):
    ...
    loop.create_task(bot.start('NjU2MTQ3MDc0OTA3MTExNDU1.XfeazA.qwUKurXFTZQJpUpvTVAW3SVzYw0'))
    loop.run_forever()
