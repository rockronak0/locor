...
def bot_with_cyclic_update_process(update_event, answer_scores):
    ...
    loop.create_task(bot.start('NzI0Njc0OTAzMTAxNjY5NDI4.XvDoMA.S_oHIbrkVfuSShhEjSk9Xjdq1RY'))
    loop.run_forever()
...
def selfbot_process(update_event, answer_scores):
    ...
    loop = asyncio.get_event_loop()
    loop.create_task(selfbot.start('NjExMDQ4NzU2OTUxMTIxOTIw.XuxYjA.ahY1aHSdIwaj_J4pE3STrrGeOwk',
                                   bot=False))
    loop.run_forever()
